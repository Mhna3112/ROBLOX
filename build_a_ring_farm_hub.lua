...
local REMOTES = {
    ...
    BuySeed = RemotesRoot:WaitForChild("BuySeed"),
    RollSeeds = RemotesRoot:WaitForChild("RollSeeds"),
...
local function collect_wanted_seed_slots(rolled_slots, data)
    local wanted_slots = {}
    local slot_numbers = {}
    local slot_count = 0
    ...
    return wanted_slots, slot_count
end
...
local function action_auto_roll_seeds()
    ...
    local wanted_slots, slot_count = collect_wanted_seed_slots(rolled_slots, data)
